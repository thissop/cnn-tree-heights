def main(output_dir:str='',
         input_data_dir:str='/Users/yaroslav/Documents/Work/NASA/current/data/samples/mosaic-0-samples-0/processed', 
    ...
    import pytorch_unet
    from cnnheights.pytorch.unet_1 import UNet as UNet_one
    from cnnheights.pytorch.unet_2 import UNet as UNet_two
    import os 
    from cnnheights.pytorch.utils import load_data
    from cnnheights.pytorch.train import train_model
