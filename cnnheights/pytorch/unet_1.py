...
class UNet(nn.Module):
    def __init__(self, in_channels=2, out_channels=1, layer_count=64):
        super().__init__()

        self.inc = DoubleConv(in_channels, layer_count)
        ...
        self.outc = nn.Conv2d(layer_count, out_channels, kernel_size=1)
