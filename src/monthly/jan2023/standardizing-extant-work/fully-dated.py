from cnnheights.utilities import shadow_heights_from_annotations
...
print(shadow_heights_from_annotations(annotations_gpkg, cutlines_shp, north=1706575.98, east=446542.55, epsg='32628', save_path=save_path))
