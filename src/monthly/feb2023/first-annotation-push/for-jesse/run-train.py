...
def run_train(data_dir:str='/ar1/PROJ/fjuhsd/personal/thaddaeus/github/cnn-tree-heights/src/monthly/feb2023/first-annotation-push/for-jesse/first-shadows-dataset', 
              output_dir:str='/ar1/PROJ/fjuhsd/personal/thaddaeus/github/cnn-tree-heights/src/monthly/feb2023/first-annotation-push/for-jesse/model-output', 
